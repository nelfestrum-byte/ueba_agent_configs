...
│   │   │       ├── freeipa.lua          — нормализация FreeIPA событий (клиентский pipeline)
│   │   │       ├── docker_events.lua    — санитизация Docker Events API (клиентский pipeline)
│   │   │       └── remove_commas.lua    — препроцессинг keycloak logfmt (клиентский pipeline)
